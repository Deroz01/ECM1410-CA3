...
public class SocialMedia implements SocialMediaPlatform {
    ...
    public Post getParentPost (Post comment){
        Post parentPost = null;
        for (Post post : posts) {
            if (comment instanceof Comment && comment.getId() == ((Comment)comment).getOrginalPostId()){
                parentPost = post;
            }
        }
        return parentPost;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            a.commentPost("user2", firstPost, "Test more");
        ...
        //for (Post post: a.getPosts()) { System.out.println(post); }

        try{
            a.showPostChildrenDetails(0);
        }
